      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-l-4 border-l-blue-500 rounded-sm">
          ...
          <CardContent className="p-4 pt-0">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              2 consultas, 1 reunião, 2 pendências
            </p>
            <Button variant="link" size="sm" className="px-0 h-auto mt-2" asChild>
              <Link to="/agenda">
                Ver agenda de hoje <ArrowRight className="h-3 w-3 ml-1" />
              </Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-orange-500 rounded-sm">
          ...
          <CardContent className="p-4 pt-0">
            ...
            <Button variant="link" size="sm" className="px-0 h-auto mt-2" asChild>
              <Link to="/crm">
                Abrir leads <ArrowRight className="h-3 w-3 ml-1" />
              </Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-red-500 rounded-sm">
          ...
          <CardContent className="p-4 pt-0">
            ...
            <Button variant="link" size="sm" className="px-0 h-auto mt-2 text-red-600" asChild>
              <Link to="/financeiro">
                Resolver pendências <ArrowRight className="h-3 w-3 ml-1" />
              </Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-green-500 rounded-sm">
          ...
          <CardContent className="p-4 pt-0 flex flex-col gap-2">
            <Button variant="outline" size="sm" className="justify-start" asChild>
              <Link to="/agenda">
                <Calendar className="h-4 w-4 mr-2" /> Planejar Semana
              </Link>
            </Button>
            <Button variant="outline" size="sm" className="justify-start" asChild>
              <Link to="/crm">
                <Contact className="h-4 w-4 mr-2" /> Retornar Contatos
              </Link>
            </Button>
          </CardContent>
        </Card>
            ...
            <div className="divide-y">
              <div className="p-4 flex items-start gap-3 hover:bg-muted/10 transition-colors">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <Button size="sm" variant="link" className="px-0 h-auto justify-start text-xs">
                    Resolver conflito
                  </Button>
                </div>
              </div>
